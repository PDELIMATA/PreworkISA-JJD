...
//        System.out.println(fileName+" contains "+ items.size()+" items.");
    ...
    //    System.out.println("\nU1 Rocket weight = " + r.weight + "; maxWeight = " + r.maxWeight);
        ...
        for (Item i : list){
            ...
            while (!r.canCarry(i)) {
  //              System.out.println(" Adding next Item " + itemCounter + ": " + i.name + " = " + i.weight + " failed -> No." + rocketCounter + " U1 full");
 ...
 //           System.out.println("Item " + itemCounter + ": " + i.name + " = " + i.weight + "; Rocket weight = "+ r.currentWeight + "; Item added");
 ...
 //       System.out.println("U2 Rocket weight = " + r.weight + "; maxWeight = " + r.maxWeight);
        ...
        for (Item i : list) {
            ...
            while (!r.canCarry(i)) {
 //               System.out.println(" Adding next Item " + itemCounter + ": " + i.name + " = " + i.weight + " failed -> No." + rocketCounter + " U2 full");
                rocketCounter++;
                fleet.add(r);
                r = new U2();
            }
